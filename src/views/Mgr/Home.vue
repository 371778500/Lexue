	...
	<el-row class="panel">
		<el-col :span="24" class="panel-top">
			<el-col :span="20" style="font-size:26px;">
				<img src="../../assets/logo5.png" class="logo"> <span>乐学网<i style="color:#20a0ff">后台管理</i></span>
			</el-col>
			<el-col :span="4">
		...
		<el-col :span="24" class="panel-center">
			...
			<aside style="width:230px;">
				...
				<el-menu style="border-top: 1px solid #475669;" default-active="/table" class="el-menu-vertical-demo" @open="handleopen"
					...
					<el-submenu index="1">
						<template slot="title"><i class="el-icon-message"></i>分站管理</template>
						<el-menu-item index="/qrcodeTable">分站列表</el-menu-item>
					</el-submenu>
					<el-submenu index="2">
						<template slot="title"><i class="el-icon-message"></i>问卷管理</template>
						<el-menu-item index="/questionTable">问卷题库</el-menu-item>
						<el-menu-item index="/questionNaireTable">问卷列表</el-menu-item>
					</el-submenu>
					<!--<el-submenu index="2">
			...
			<section class="panel-c-c">
				<div class="grid-content bg-purple-light">
					<el-col :span="24" style="margin-bottom:15px;">
						<strong style="width:200px;float:left;color: #475669;font-size: 14px;">{{currentPathName}}</strong>
						<el-breadcrumb separator="/" style="float:right;">
							<el-breadcrumb-item :to="{ path: '/questionTable' }">首页</el-breadcrumb-item>
...
<script>
  export default {
    data() {
      return {
		  currentPathName:'问卷题库',
		  currentPathNameParent:'问卷管理',
        form: {
          name: '',
          region: '',
          date1: '',
